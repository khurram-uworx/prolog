namespace Prolog
{
    ...
    public interface IUnificationEngine
    {
        ...
        /// </summary>
        /// <param name="term1">First term to check</param>
        /// <param name="term2">Second term to check</param>
        /// <param name="bindings">Existing variable bindings</param>
        /// <returns>True if terms can be unified, false otherwise</returns>
        bool CanUnify(Term term1, Term term2, Dictionary<string, Term> bindings);
    }
}